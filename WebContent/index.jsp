...
<div class="container">
    <div class="row header">
        <div class="col-sm-4 logo">
            <h1><a href="/proj1b">CS5300 Proj1b</a> <span>.</span></h1>
        </div>
        <div class="col-sm-8 call-us">
            <p>Shibo Zang: <span>sz428</span> | Yihui Fu: <span>yf263</span> | Giri Kuncoro: <span>gk256</span> </p>
        </div>
    </div>
</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p>Currently, Server ID <span class="server-id"></span> with reboot number <span class="reboot-num"></span> is executing the client request. The session data was found on server ID <span class="source-server-id"></span>.</p>
                    <div class="session">
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 subscribe">
            <h3 id="info"></h3>
            <p><b>Cookie Value:</b> <span id="cookie-id"></span> | <b>Cookie metadata:</b> <span id="cookie-metadata"></span> | <b>Cookie-domain:</b> <span id="cookie-domain"></span></p>
            <p><b>Curr time: </b> <span id="curr-time"></span> | <b>Exp time: </b> <span id="exp-time"></span></p>
            <form class="form-inline" role="form" method="post">
            	<div class="form-group">
            		<label class="sr-only" for="message">Session state message</label>
                	<input type="text" name="Message" placeholder="Enter your message..." class="replace-msg form-control" id="message" maxlength="512">
                </div>
    ...
    <div class="row">
        <div class="col-sm-12 social">
            <a id="refresh" data-toggle="tooltip" data-placement="top" title="Refresh"><i class="fa fa-refresh"></i></a>
            <a id="logout" data-toggle="tooltip" data-placement="top" title="Logout"><i class="fa fa-sign-out"></i></a>
        </div>
    </div>
</div>
